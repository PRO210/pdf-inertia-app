                                        ...
                                        >
                                            ...
                                            <div className="pt-10 sm:pt-5 lg:pt-0">                                                
                                                <p className="mt-4 text-2xl/relaxed text-justify">
                                                    Nosso app transforma qualquer imagem em um pôster ampliado em PDF, pronto para impressão. É fácil de usar, não precisa instalar nada e funciona direto do navegador, em qualquer dispositivo. Ideal para quem quer criar pôsteres grandes sem complicação basta fazer o login e pronto :).
                                                </p>
                                            </div>
                                        </div>
